...
class UsuarioCustomizado(BaseUserManager):
    ...
    #def criar_medico(self, nome, password, is_superuser=False, is_staff=False, **extra_fields):
     #   return self._criar_usuario(nome, password, is_superuser, is_staff, **extra_fields)
